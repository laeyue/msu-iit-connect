...
const posts = [
  {
    id: 1,
    title: "Engineering Students Build Solar-Powered Campus Facility",
    excerpt: "COE students showcase sustainable engineering solutions with innovative renewable energy project.",
