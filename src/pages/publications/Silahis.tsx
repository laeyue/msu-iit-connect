      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <img src={silahisLogo} alt="Silahis logo" className="w-16 h-16 rounded-lg object-cover" />
          ...
          <a 
            href="https://www.facebook.com/TheSilahisPublication" 
            target="_blank" 
        ...
        <section>
          <FacebookFeed publicationId="silahis" limit={3} />
        </section>
