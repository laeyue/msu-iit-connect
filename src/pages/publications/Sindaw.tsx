...
const posts = [
  {
    id: 1,
    title: "Business Students Launch Campus Entrepreneurship Fair",
    excerpt: "CEBA students showcase innovative business ideas and startups to the university community.",
