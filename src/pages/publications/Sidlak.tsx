...
const posts = [
  {
    id: 1,
    title: "Education Department Launches New Teaching Initiative",
    excerpt: "Innovative program aims to enhance learning experiences for students across all levels.",
